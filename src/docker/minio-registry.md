...
As documented in [another of my notes on Docker Swarm](https://github.com/fjebaker/notes/blob/master/docker/docker-swarm.md), we can deploy a registry service with
```bash
